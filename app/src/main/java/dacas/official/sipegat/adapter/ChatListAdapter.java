...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            textView = (TextView) v.findViewById(R.id.nameUser);
            textView2 = (TextView) v.findViewById(R.id.Description);
            icon = (ImageView) v.findViewById(R.id.imageProfile);
        }
     ...
     */
    public ChatListAdapter(String[] dataSet,String[] dataSet2, int[] dataSet3) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.chat_list_view, viewGroup, false);
